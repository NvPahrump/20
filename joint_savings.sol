...
/*2*/
        ...
        /*
        Define a `require` statement that checks if the `balance` is sufficient to accomplish the withdraw operation. If there 1Gare insufficient funds, the text `Insufficient funds!` is returned.
        */
        // YOUR CODE HERE!
/*3*/
